...
def upgrade() -> None:
    ...
    op.create_table('triggers',
        ...
        sa.Column('entity_type', sa.Enum('MONITOR', 'MONITOR_STATUS', 'TAG', name='entitytype'), nullable=False),
        sa.Column('change_types', postgresql.JSON(astext_type=sa.Text()), nullable=False),
    ...
    op.create_table('trigger_events',
        ...
        sa.Column('change_type', sa.Enum('INSERT', 'UPDATE', 'DELETE', name='changetype'), nullable=False),
